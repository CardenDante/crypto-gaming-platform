...
const Layout: React.FC<LayoutProps> = ({ children, title = 'Crypto Gaming Payment System' }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Head>
        <title>{title}</title>
        <meta name="description" content="Crypto Gaming Payment System" />
        ...
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          <div className="md:flex md:items-center md:justify-between">
            <div className="text-center md:text-left">
              <p className="text-sm">© {new Date().getFullYear()} CryptoGaming Payment System</p>
            </div>
